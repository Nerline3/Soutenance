...
// aucun résultat n'est retourné
    if ($infoUser->rowCount() == 0) {
        ...
        exit();
    }  /*  vérifie s'il existe des résultats dans la requête  $infoUser */
